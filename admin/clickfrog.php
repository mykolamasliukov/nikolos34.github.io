  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="clickfrog.php">Click<span style="font-style:italic;">frog</span></a></li>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Click<span style="font-style:italic;">frog</span></h1>
<?php if(isset($result) && $result !== false): ?>
<div class="alert alert-success" role="alert">Запись успешно обновлена</div>
	<?php endif; ?>			
        <form method="post" action="" role="form">
		 <div class="form-group">
			<label for="exampleInputEmail1">Введите код Click<span style="font-style:italic;">frog</span></label>
