  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Инструкция</h1>
        <p class="lead">Выберите в меню атрибут который хотите изменить.<br />Для выхода из админ. панели нажмите кнопку "Выход". Если же нет, то Вы автоматически выйдете через час.</p>
