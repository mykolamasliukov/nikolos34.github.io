...
<html lang="en">
  <head>
    ...
    <title>Анель администратора</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li   class="active"><a href="google.php">Google Analytics</a></li>
	...
	<?php endif; ?>		
        <form method="post" action="" role="form">
		 <div class="form-group">
			<label for="exampleInputEmail1">Введите код Google Analytics</label>
