function email_focus() {
	if ($(this).val() == 'http://pantra.ru/upsell/timer/js/your@email.com') {
		$(this).val('')
...
function email_blur() {
	if ($(this).val() == '') {
		$(this).val('http://pantra.ru/upsell/timer/js/your@email.com')
		$(this).addClass('faded');
	}	
}
...
function subscribe_submit() {
	...
	$.post('http://pantra.ru/upsell/timer/js/subscribe.php?json=1', $('#subscribe_form').serialize(), subscribe_result, 'json');
