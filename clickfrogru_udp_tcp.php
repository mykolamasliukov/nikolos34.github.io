...
/*
	...
	Если же проверка кода по указаному адресу говорит "Серверный скрипт: есть" - вы некорректно подключили скрипт к страницам вашего сайта.
*/   

class ClickfrogUDPSender
{
	private static $CLFG_REQUEST = array('_COUNTER_UDP_IP' => '62.149.12.92', '_COUNTER_UDP_PORT' => '83', '_COUNTER_HOST' => 'stat.clickfrog.ru', '_COUNTER_GET'=>'/server_side_action.php');
